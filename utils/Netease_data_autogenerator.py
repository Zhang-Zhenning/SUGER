...
file_num = 200
os.chdir(os.path.join(data_root, r"baseline_data\Netease\train_test_data"))
...
# # only sample 0.3 of whole user
# all_users = all_users[:int(0.04*num_users)]
...
# test_users = np.load(r"D:\SGCN\baseline_data\Netease\train_test_data\1\r_test_users.npy")
# train_users = np.load(r"D:\SGCN\baseline_data\Netease\train_test_data\1\r_train_users.npy")
...
dict2 = extract_subgraphs_thread(1,user_range=test_users[:297])
